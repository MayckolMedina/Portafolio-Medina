    ...
    return (
        <section id="contact" className="contact-section">
            ...
            <div className="contact-links">
                <a href="mailto:mayckolmedina56@gmail.com" className="contact-btn email-btn">
                    mayckolmedina56@gmail.com
                </a>
                <a href="https://wa.me/51961464091" target="_blank" rel="noopener noreferrer" className="contact-btn whatsapp-btn">
